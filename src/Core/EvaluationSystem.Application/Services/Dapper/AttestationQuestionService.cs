...
namespace EvaluationSystem.Application.Services.Dapper
{
    public class AttestationQuestionService : IAttestationQuestionService
    {
        ...
        public void Create(int moduleId, QuestionDto questionDto)
        {
        ...
        {
            AttestationQuestion question = new AttestationQuestion() { Name = questionDto.Name, Type = questionDto.Type };
